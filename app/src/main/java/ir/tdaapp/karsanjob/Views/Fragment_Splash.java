...
import ir.tdaapp.karsanjob.DataBase.Tbl_Setting;
import ir.tdaapp.karsanjob.Enum.ForcedUpdate;
...
import ir.tdaapp.karsanjob.ViewModel.VM_Versions;
...
public class Fragment_Splash extends BaseFragment implements View.OnClickListener {
    ...
    void DateTime() {
        ...
        handler_lbl_karSan.postDelayed(() -> {
        ...
        handler_NextPage.postDelayed(() -> GetVersionsInServer(), 2000);
    }
