...
import ir.tdaapp.karsanjob.Services.IRefreshPage;
...
//                        btn_Undo.setVisibility(View.VISIBLE);
    ...
    void SetTypeItem(int Type) {
        try {
            ...
            Dialog_Confirm dialog_confirm = new Dialog_Confirm(getString(R.string.The_amount_of_20000_Tomans_will_be_deducted_from_your_wallet), new onClickDialog_Confirm() {
                @Override
                public void ok() {
