...
public class Fragment_Show_Details_Favorite extends BaseFragment {

    public static final String TAG = "Fragment_Show_Details_Favorite";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_show_details_favorite,container,false);
